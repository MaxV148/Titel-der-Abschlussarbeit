...
Log-Template im Mittel lediglich 10\,000 Einträge
enthält \ref{sec:eval:aufbau},
...
\begin{figure}[h]
    ...
    \caption{$k$-Distanz-Plot für DBSCAN mit Cosinus-Distanz und $k = 2$. Der per \texttt{KneeLocator} bestimmte Knick liegt bei $\varepsilon \approx 0{,}399$ (grün gestrichelt)}
