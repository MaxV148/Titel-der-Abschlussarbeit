...
Die Homogenität von $57{,}391\,\%$ zeigt, dass die mit $\varepsilon = 0{,}4$
gebildeten Cluster überwiegend intern sauber sind. Die Vollständigkeit von
$62{,}649\,\%$ ist demgegenüber moderat; sie ist Folge der mit $124$
Clustern deutlich höheren Cluster\-anzahl gegenüber den $44$
...
jedoch das geringere Übel darstellt: reine Cluster lassen sich nachgelagert
...
die erzielbare Vollständigkeit. DBSCAN bleibt für den kontinuierlichen
Betrieb aus denselben Gründen wie K-Means ungeeignet: Eine inkrementelle
Erweiterung ist ohne vollständige Neuberechnung der
Nachbarschaftsstruktur nicht möglich.
...
\begin{table}[h]
    \centering
    \caption{Evaluationsergebnisse DBSCAN im Einzeldurchlauf ($\varepsilon = 0{,}4$, \texttt{min\_samples} $= 2$, Seed $42$)}
