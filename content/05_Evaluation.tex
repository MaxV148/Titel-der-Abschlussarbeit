...
Ursächlich für den niedrigen ARI ist eine massive Untersegmentierung: Von
den $13$ gebildeten Clustern vereint ein einzelner Cluster $9\,527$ der
$10\,000$ Lognachrichten ($95{,}3\,\%$) auf sich; die übrigen zwölf Cluster
umfassen jeweils zwischen $6$ und $84$ Punkten und sind nahezu durchgehend
rein (jeweils eine, in einem Fall zwei Ground-Truth-Klassen). Der
Makrocluster enthält dagegen Vertreter aus $37$ der $44$
Ground-Truth-Klassen, wodurch die Homogenität auf $7{,}201\,\%$ einbricht --
...
Klassen-Kohäsion erhält, jedoch keine perfekte Vollständigkeit liefert, da
die übrigen Klassen auf die zwölf kleineren Cluster aufgeteilt sind.

Dieses Verhalten entspricht der Fehlfunktion eines zu groß gewählten
$\varepsilon$, wie sie auch in der sklearn-Dokumentation beschrieben wird:
Ein zu großer Radius führt dazu, dass benachbarte, eigentlich separate
Cluster verschmelzen und im Extremfall der gesamte Datensatz als ein
einziger Cluster zurückgegeben
wird\footnote{Dokumentation zu \texttt{sklearn.cluster}
\url{https://scikit-learn.org/stable/modules/clustering.html\#dbscan}}. Im
Gegensatz zu einem zu klein gewählten $\varepsilon$ entstehen dabei keine
Rauschpunkte: Bei $\varepsilon = 0{,}65$ findet praktisch jeder Punkt
ausreichend viele Nachbarn, um als Kernpunkt zu gelten, sodass kein Punkt als
Ausreißer (Label $-1$) klassifiziert wird. DBSCAN bleibt für den
