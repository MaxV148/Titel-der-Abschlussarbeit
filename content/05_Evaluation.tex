...
Schwellenwerten erzielt der vektorbasierte Ansatz einen ARI von $80{,}103\,\%$
...
$83{,}865\,\%$ zeigt, dass die so entstehenden Cluster intern überwiegend
sauber sind; gleichzeitig erreicht die Vollständigkeit mit $94{,}979\,\%$
...
Wahl jedoch aus -- der berichtete Wert von $80{,}103\,\%$ ist daher das
...
\begin{table}[h]
    ...
    \caption{Evaluationsergebnisse pgvector + Sentence-Transformer im Einzeldurchlauf
             (\texttt{initial\_dist} $= 0{,}3$, \texttt{recluster\_dist} $= 0{,}2$,
             \texttt{initial\_ratio} $= 0{,}5$, Seed $42$)}
