...
\end{enumerate}
Auf dieser Grundlage werden in Abschnitt~\ref{sec:kommerziell_marktueberblick} vier Systeme vertieft betrachtet (Datadog, Elastic, Grafana Loki, Sumo Logic); Abschnitt~\ref{sec:kommerziell_weitere} fasst zwei weitere Systeme (Dynatrace, AWS CloudWatch Logs Insights) knapper zusammen.
