...
Kibana eignet sich gut für die Suche nach Log-Nachrichten, löst jedoch ein zentrales Problem nicht: Viele Logs unterscheiden sich nur durch Metadaten wie Zeitstempel oder \ac{IP}-Adressen, besitzen aber die gleiche Aussage. Mehr zum Stand der Technik im Kapitel \ref{chap:kommerziell}
...
struktureller Eignung für den kontinuierlichen Betrieb. Dazu werden fünf Ansätze -- vier algorithmische Verfahren (K-Means, DBSCAN, Drain3, Brain) sowie ein vektorbasierter Ansatz auf Basis von Sentence-Embeddings und PostgreSQL mit \texttt{pgvector}-Erweiterung verglichen.
...
Der vektorbasierte Ansatz auf Basis von
