...
(Abschnitt~\ref{sec:kmeans}) das partitionierende Paradigma und dient
zugleich als Baseline für die nachfolgenden Vergleiche. DBSCAN
...
Nach dem Vergleich der Clustering-Algorithmen bewerten zwei Metriken die Qualität: der ARI-Wert \cite{gates2017impactrandommodelsclustering} (Adjusted Rand Index) und das V-Measure \cite{inproceedings}.

\paragraph{Adjusted Rand Index.}
Der Adjusted Rand Index~(ARI) \cite{YANG201719} misst, wie gut zwei
...
ist. Als Weiterentwicklung des ursprünglichen Rand-Index (RI) korrigiert
