...
\begin{logbox}{Beispiel 2: \ac{SSH} Login-Fehler}
\begin{lstlisting}
...
Nach dem Vergleich der Clustering-Algorithmen bewerten zwei Metriken die Qualität: der \ac{ARI}-Wert \cite{gates2017impactrandommodelsclustering} und das V-Measure \cite{inproceedings}.
