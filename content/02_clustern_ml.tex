...
\begin{equation}
    ...
    \label{eq:lsh_prob}
\end{equation}
Die Parameter sind $s \in [0, 1]$ (Jaccard-Ähnlichkeit des Paares), $r \in \mathbb{N}_{>0}$ (Zeilen pro Band) und $b \in \mathbb{N}_{>0}$ (Anzahl der Bänder); die Funktion liefert einen Wert in $[0, 1]$. Durch Variation von $b$ und $r$ lässt sich die Schwellwertkurve so steuern, dass der Übergang von „kein Kandidat" zu „Kandidat" einem annähernden Stufensprung gleicht \cite{Leskovec2020_Kap3_4_2}.
