...
Nach der Datenbankwahl folgt die Implementierung eines Algorithmus zur kontinuierlichen Gruppierung der Lognachrichten mithilfe der Vektordatenbank. Diese Vorgehensweise wurde wärende der Praxisphase entwurfen und pratkisch eingesetzt. Da das System periodisch neue Logs übermittelt, deckt der Algorithmus zwei Zustände ab. Zunächst erfolgt eine initiale Gruppierung, sofern noch keine Loggruppen vorliegen, dieser Teil wird im Regelfall nur einmal ausgeführt wenn das System ohne bestehende Daten startet. Anschließend erweitern neue Logs die bestehenden Gruppen.
